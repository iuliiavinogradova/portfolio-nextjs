                            ...
                            <form action="https://getform.io/f/e7c6dff1-8b46-452d-bbbd-3f0eb33c73b7" method="POST">
                                <div className='grid md:grid-cols-2 gap-4 w-full py-2'>
                                    <div className='flex flex-col'>
                                        ...
                                        <input className='border-2 rounded-lg flex border-gray-300 p-3' type='text' name='name' />
                                    </div>
                                    <div className='flex flex-col'>
                                        <label htmlFor='email' className='uppercase text-sm py-2'>Email</label>
                                        <input className='border-2 rounded-lg flex border-gray-300 p-3' type='email' name='email' />
                                    </div>

                                </div>
                                <div className='flex flex-col'>
                                    <label htmlFor='subject' className='uppercase text-sm py-2'>Subject</label>
                                    <input className='border-2 rounded-lg flex  border-gray-300 p-3' type='text' name='subject' />
                                </div>
                                <div className='flex flex-col'>
                                    <label htmlFor='message' className='uppercase text-sm py-2'>Message</label>
                                    <textarea className='border-2 rounded-lg  flex p-3 border-gray-300' rows={10} name='message' />
                                </div>
